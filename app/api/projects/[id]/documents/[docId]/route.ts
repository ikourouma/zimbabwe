...
/**
 * DELETE /api/projects/[id]/documents/[docId] (admin/super_admin) — removes the DB row only; the
 * R2 object is left in place, consistent with the soft-delete convention used elsewhere (never a
 * destructive storage-provider call from a single admin action).
 */
