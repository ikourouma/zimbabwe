...
/**
 * Reports workspace for Platform Admin — "Executive Report" (the platform-wide Government
 * Executive Report, this page's original sole purpose) plus "Activity Report" (the super admin's
 * own personal activity log, same component the Deal Room Reports page already gives every
 * persona), on ElevatedTabsList tabs matching /deal-room/reports' pattern (Platform Feedback
 * Batch v4, Phase 2).
 */
  ...
  if (!isLoading && !isSuperAdmin) {
    return (
      <AccessGate
        ...
        description="Sign in with a super admin account to generate the Government Executive Report."
      />
    );
  }
