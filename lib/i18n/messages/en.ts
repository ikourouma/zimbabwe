...
export const enMessages = {
  ...
  footer: {
    ...
    demoNotice: "Official content is subject to Government of Zimbabwe and ZIDA validation",
    ...
    tagline: "ZIDA Investment Intelligence",
  },
  breadcrumb: {
    home: "Home",
  ...
  classificationStrip: [
    { label: "Classification", value: "Governed Investment Platform" },
    { label: "Status", value: "Operational" },
    { label: "Registry Access", value: "Role-Based Access" },
    { label: "Endorsement", value: "ZIDA-Governed" },
  ],
  accessTiers: [
    {
      id: "public",
  ...
  auth: {
    ...
    applyForAccess: "Create an account",
    ...
    signUpSubtitle: "Register instantly for registry access. Qualify for the full Deal Room and financial detail later via a Strategic Partnership inquiry.",
    name: "Full name",
    ...
    exploreOpportunityFirst: "Have a specific opportunity in mind?",
    startPartnershipInquiry: "Start a Strategic Partnership inquiry →",
    welcomeNewToast: "Welcome, {name}",
    welcomeNewToastFallback: "Account created successfully",
  },
  accountMenu: {
    ...
    roles: {
      ...
      ministry_admin: "Ministry Official",
      admin: "ZIDA Admin",
