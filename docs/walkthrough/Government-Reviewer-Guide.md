...
Two tabs sit under Reports — My Activity Summary, open here, and National Executive Briefing. The activity report renders as a formal document rather than a dashboard: headed Republic of Zimbabwe · Investment Platform, carrying its own reference number, generated by Tafadzwa Mutasa (Government), with a snapshot timestamp to the second and its source recorded as live platform data. The account summary states name, email, organisation and role, and marks the Confidentiality Framework accepted. An engagement summary follows it: ten engagements in total, US$204.3 million of tracked indicative capital across all ten, three pending review and six approved. Beneath that, My Engagements sets out each approach against a project in the national pipeline with its status, its indicative ticket, the date it started and the next step it awaits — proceed to MOU drafting on the Masuwe International Medical Center Project, await a decision on Goromonzi Agro Processing, complete and submit for review on the one still in draft. A print or save-as-PDF control sits above the document.
