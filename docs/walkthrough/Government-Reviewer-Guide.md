...
The console opens on Deal Room Overview, and the left rail is badged Government Reviewer Console rather than as an investor workspace. Four figures carry the national position: thirty-seven projects in pipeline, twenty-six published, eight under assessment and ten engagements. Below them the Engagement Funnel plots investor approaches by stage — submitted, under compliance review, approved, rejected. The Platform Snapshot records twenty-six published projects, US$2.21 billion of capital and four investors, with published projects broken out by sector. Beside it, Recent Activity carries the national trail rather than the reader's own file: Grace Mutindi sending a message to the ZIDA deal team, and logging new engagements on the MNHSA Livingstone Flats Project and on Foot and Mouth Disease (FMD) Vaccine Manufacturing, each entry named to its actor and stamped with how long ago it occurred.

Eight projects under assessment is the reviewer's own workload — the tile gathers everything submitted for review, under review or returned for changes, which is why it is not named after any one of those statuses — and it sits beside the twenty-six already published, so the ratio of what is being assessed to what has reached the registry is legible immediately. The sector breakdown answers the question a minister asks first: where the pipeline is concentrated. My Analytics is kept separate and personal — saved projects, documents previewed, messages sent — so an officer's footprint is measured on its own terms rather than folded into the national aggregate. Recent Activity is scoped the other way, to the remit rather than to the reader, which is the correct scope for a role whose work is to assess what other parties have done: a panel confined to a reviewer's own actions would stand empty on precisely the account that most needs to see movement.
...
Here the national portfolio is laid out as a board, one column per stage: draft, submitted for review, under review, changes requested, approved, published and archived. Counts appear on each column and again as filter chips above them — thirty-seven records in all, twenty-six of them published, with one in draft, three submitted for review, four under review, one returned for changes, one approved and one archived. Cards name sector and, where a capital figure has been recorded, a single headline amount — Powertel Fibre Internet (GPON) at US$26.9 million, Solgas Energy's 10MW solar project at US$7.54 million, Lot 1 of Jafuta Estate at US$81.6 million — while five cards show their sector alone, no figure having yet been recorded against them. The same records can be read as a list, a table or a matrix.

Congestion cannot hide on a view like this. Three submissions waiting to be picked up and one project sitting at approved tell a reviewer, and anyone looking over their shoulder, exactly where the pipeline has stalled and where it has not. The approved column is the more consequential of the two: that project has cleared substantive assessment and is waiting on ZIDA to publish it. That gap between approved and published is not a delay in the workflow — it is the workflow, made visible.
...
Ten investor engagements are listed nationally, each row naming the investor, the organisation behind them, the project approached and the current status. Nomsa Dube of Kestrel Capital Partners stands at approved against the Masuwe International Medical Center Project, with a term sheet under legal review and a site visit completed; James Okafor of Sahara Frontier Infrastructure Fund is under compliance review on Goromonzi Agro Processing, awaiting an updated feasibility study. Grace Mutindi of Zambezi Growth Partners accounts for five of the six approved engagements, and each carries its own account of where it has reached: among them, a grid connection study reviewed on Kumusha Power, terms approved on the investor's side and with ZIDA for counter-approval on Goromonzi, both parties' approval of the draft terms on TelOne Fibre to the Home, and content frozen with signature awaiting scheduling on Foot and Mouth Disease Vaccine Manufacturing. The status cell on each row is a control, and the chips above count two submitted, one under compliance review and six approved.

What this establishes is that an approach to the Zimbabwean state is a recorded case rather than a conversation. Every engagement carries a named counterparty, a specific project, a stage and the date it last moved; the three still at draft or submitted show a dash in the Notes column, while every engagement that has been taken up carries a note explaining why it stands where it does. A reviewer can therefore answer, without asking anyone, which investors are waiting on government and which are waiting on their own submissions — and so can an auditor reading the same rows a year later.

### MOU Registry

![The MOU Registry. Your role here is approval, not drafting.](docs/screenshots/government/mou.png)

Ten records are grouped by stage, and the stages are kept deliberately distinct: no MOU yet, drafting, in review, both parties approved, finalized, ready for signature and executed. Four records sit at no MOU yet, one is drafting, one in review, one has both parties' approval, one is finalized, one is ready for signature and one executed. Each row sets the engagement's status against the memorandum's stage, alongside ticket sizes where the investor has stated them — $5M–$25M, $1M–$5M, $25M–$100M. The register exports to CSV.
...
Two tabs sit under Reports — My Activity Summary, open here, and National Executive Briefing. The document is titled Activity Report and subtitled *Investor engagements within your remit, and your account standing on the platform*, and it renders as a formal document rather than a dashboard: headed Republic of Zimbabwe · Investment Platform, carrying its own reference number, generated by Tafadzwa Mutasa (Government), with a snapshot timestamp to the second and its source recorded as live platform data. The account summary states name, email, organisation and role, and marks the Confidentiality Framework accepted. An engagement summary follows it: ten engagements in total, US$61 million of investor-stated ticket value — counted, as the caption beneath the figure says, across the five of the ten in which the investor stated a ticket — three pending review and six approved. Beneath that, Engagements In Your Remit sets out each approach against a project in the national pipeline with the investor who made it — named, and with their organisation where one is recorded — alongside its status, its indicative ticket, the date it started and the next step it awaits. The investor column is not decoration: two firms may approach the same project, and without a name against each row the two would read as one record entered twice. That next step now reads the memorandum's own stage where one exists: Nomsa Dube of Kestrel Capital Partners awaits signature on the Masuwe International Medical Center Project, James Okafor of Sahara Frontier Infrastructure Fund awaits a decision on Goromonzi Agro Processing, Grace Mutindi of Zambezi Growth Partners awaits completion of the MOU draft on the Kumusha Power Project, the two engagements still submitted — one of them Chipo Marufu of Diaspora Growth Syndicate on Misty Mountains Coffee Production — await ZIDA desk review, and the one still in draft awaits completion and submission for review. Where the investor has stated no ticket of their own, the Indicative Ticket column shows the project's published ask instead and marks it as such; those figures are context rather than commitments, and the headline total does not carry them. A print or save-as-PDF control sits above the document.
...
One inbox holds three threads, filtered as general enquiries, active deals and engagements: three in all, one on the general channel and two attached to deals. Threads on the left show message counts and the last contributor, titled by project where they concern one and by correspondent where they run on the general channel. The open thread is Grace Mutindi's, headed as a general enquiry on the project-less concierge channel and holding a single message, *Sector guidance ahead of a Q4 allocation*, in which a qualified investor asks which published opportunities are closest to financial close and where a ministry sponsor is already engaged. The two project threads beneath it, on the TelOne Data Centres Project and the Eunigaga Chegutu Solar PV Power Plant, each carry a recorded amendment request as their most recent entry.

Correspondence and governance action occupy the same thread here, so the reasoning behind a decision is stored next to the decision rather than in somebody's mailbox — which is why an amendment request stands in the thread list on the same terms as a question about sector guidance. The composer's visible-to-investor setting keeps internal deliberation and investor-facing reply in one record without confusing the two. Threads export to CSV or PDF, and the stated response expectation of one business day sits on the page, which means an investor's sense of how the state communicates rests on something measurable.

![The Document Vault.](docs/screenshots/government/vault.png)

Four cards make up the vault. The first records the non-disclosure certificate as accepted on 6 September 2026 at 5:18:21 PM, against agreement version 1.0. The second, Company & accreditation, shows business registration not uploaded and offers slots for a commitment letter and a guarantee letter. The remaining two, MOU snapshots and recent document downloads, are empty on this account, reading no MOUs yet and no downloads recorded yet.
...
The distinction worth noting is that saving carries no authority. A reviewer following a project has not been assigned it, has not claimed it and has altered nothing about its status, which is why the pipeline keeps a separate assigned-to-me filter. Across a national portfolio of thirty-seven records, an officer needs a way to keep sight of a handful of files without that interest being read as ownership of them. This page is that, and nothing beyond it.
...
| Read the national position at a glance | Overview | Projects in pipeline, published, under assessment and engagements |
