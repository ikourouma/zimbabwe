...
Four figures run across the top of the Deal Room Overview: 36 projects in the pipeline, 26 published, 8 under assessment — the three review stages counted together — and 5 engagements of your own. Below them the Engagement Funnel plots your cases against the four stages government moves them through — submitted, under compliance review, approved, rejected — with the single bar standing at approved. The lower band carries a Platform Snapshot of 26 published projects, capital of $2.21B and four investors, sector counts beneath it, and your own analytics counters — four saved projects, five engagements, no documents downloaded or previewed, one message sent — beside a Recent Activity feed recording the message you sent to the ZIDA deal team and the engagements you logged.
...
At the qualified tier the registry opens as a Kanban board of six columns — 1 draft, 3 submitted for review, 4 under review, 1 changes requested, 1 approved and 26 published, with the All filter above them reading 36, which is what the six stage counts sum to. The cards now carry money on their face, each capital requirement resolved to a single headline figure and set on its own line in gold beneath the sector: Powertel Fibre Internet (GPON) at US$26.9 million under ICT, Solgas Energy 10MW Solar at US$7.54 million under Energy, CICADA Macadamia and Avocado at US$39.5 million under Agriculture. Five cards carry no such line and show their sector alone: the three in the submitted-for-review column and two of the four under review, on which no capital figure has yet been recorded. Above the board sit search by title, location or project owner, a filter control, a save-search control, and switches to List, Table or Matrix.

The capital figure printed on the card is what makes a board screenable rather than merely readable: an investor can size an opportunity before opening it and set aside what falls outside mandate in moments. That figure is released to the registered tier as well, so what this tier adds on a project is the return metrics behind it rather than the headline number itself. Showing the draft and review columns alongside published matters as much: it tells an investor what is coming, which is what makes a pipeline worth monitoring rather than merely reading once. Archived projects are withheld from both investor tiers, a project withdrawn from the registry no longer being an investable proposition; government and ZIDA staff retain the archived column on their own boards.
...
Five engagements are listed, all raised by Grace Mutindi of Zambezi Growth Partners and all marked *Approved* — against the Kumusha Power Project, the Goromonzi Agro Processing Industrial Park, the TelOne Fibre to the Home (FTTH) Deployment, Foot and Mouth Disease (FMD) Vaccine Manufacturing and the MNHSA Livingstone Flats Project. The table gives the investor and their organisation, the project, the status, a notes column in which each case states where it has actually reached — a grid connection study reviewed on Kumusha, a site visit completed on Goromonzi, a memorandum signed in Harare on MNHSA Livingstone Flats — and the date of last update. Status filters run above it with live counts for draft, submitted, under compliance review, approved and rejected, next to a *New Engagement* control and the Kanban, List, Table and Matrix views.
...
All five memoranda arising from the approved engagements are listed, and the stage column is where the detail sits: the Kumusha Power Project memorandum is in *Drafting* and the Goromonzi Agro Processing Industrial Park memorandum has reached *In Review*, while the TelOne Fibre to the Home (FTTH) Deployment stands at *Both Parties Approved*, Foot and Mouth Disease (FMD) Vaccine Manufacturing at *Finalized* and the MNHSA Livingstone Flats Project at *Executed*. Beside each is the approved engagement status that made it available, and a ticket size — $5M–$25M, $1M–$5M, $25M–$100M, $5M–$25M and $25M–$100M respectively. Stage filters count the entire path from *No MOU Yet* through drafting, in review, both parties approved, finalized, ready for signature and executed, with a CSV export alongside; on this account only *No MOU Yet* and *Ready for Signature* stand at nil.
...
Everything the platform holds on your behalf sits in four cards here. The first is the non-disclosure certificate, accepted on 7 September 2026 at 3:54:35 PM and timed to the second against agreement version 1.0. The second covers company and accreditation material, showing business registration not yet uploaded and offering upload controls for a commitment letter and a guarantee letter. The third lists a memorandum snapshot for each of the five projects, naming the project and the stage it stands at in plain words — *Executed*, *Finalized*, *Both Parties Approved*, *In Review* and *Drafting* — with the executed and finalized entries noted as having a snapshot available. The fourth would show recent document downloads, of which none are yet recorded.
...
One thread exists on this account: *My General Channel with ZIDA*, described as your general channel with the ZIDA deal team and carrying a stated expectation of a response within one business day. The filters beside it count the categories separately — general, active deals and engagements — so correspondence sorts by what it concerns. The composer is addressed to the ZIDA deal team, with a subject selector, a message field, and Send and Attach controls. One message has been posted, Grace Mutindi's *Sector guidance ahead of a Q4 allocation*, with a Reply control beneath it and CSV and PDF exports of the thread in the header.
...
Saved Projects is a watchlist, and on this account it holds four, all of them published: the Eunigaga Chegutu Solar PV Power Plant, the CICADA Macadamia and Avocado Plantation Expansion Project, the Buck Special Grant Gold Mining Project and the Agro Strong (Pvt) Ltd Beef and Dairy Farming Venture. The table gives each one's ministry, sector, status, capital and the date it was last updated, with the same stage filters that head the Pipeline above it — draft through to published, and no archived filter, on the same reasoning — and the Kanban, List, Table and Matrix views beneath. The subtitle describes the section as a personal watchlist of investment opportunities, saved from a project's detail page or its card.
...
My Activity Report renders as a document rather than a dashboard, headed *Republic of Zimbabwe · Investment Platform* with a reference number, the account that generated it, a snapshot timestamp, and *Live platform data* named as the source. The account summary shows organisation, role, and the confidentiality framework marked accepted. Engagement figures follow: five in total, $61M of investor-stated ticket value across the five engagements on which a ticket was stated, none pending review, five approved. The table beneath names each project, its status, its ticket range, its start date and its next step; all five rows stand approved and all five began on 6 September 2026, while the next step is read from the memorandum standing behind each case and therefore differs from row to row — *Complete the MOU draft* on Kumusha Power, *Awaiting counter-approval* on Goromonzi Agro Processing, *Proceed to finalisation* on TelOne Fibre to the Home, *Schedule signature* on Foot and Mouth Disease (FMD) Vaccine Manufacturing and *Proceed to definitive agreement* on MNHSA Livingstone Flats.
...
2. Select your general channel with ZIDA, or the thread attached to your engagement or project.
