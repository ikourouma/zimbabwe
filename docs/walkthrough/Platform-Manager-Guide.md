...
Analytics opens on five counters: thirty-seven projects in total, twenty-six published and marked *Live deals*, eight under assessment carrying *Needs action*, one draft *not yet submitted*, and seven pending enquiries. Beneath them, Projects by Sector ranks the portfolio from Agriculture down through Manufacturing, Energy, ICT, Infrastructure, Mining, Health and Tourism and Finance, while Inquiries by Status resolves to a single pending band of seven. Recent Governance Activity opens with Grace Mutindi sending a message to the ZIDA deal team, followed by successive entries recording the new engagements she has logged, each naming the project it was raised against — the MNHSA Livingstone Flats Project and Foot and Mouth Disease (FMD) Vaccine Manufacturing among the first of them.
...
Ninety-three records are held here, sorted most recent first, with category filters for projects (45), user and security (10), site settings (18), VDR and documents (1) and messages and hub (19) — figures that sum exactly to the ninety-three, so every record is reachable through a category rather than only through the unfiltered list. Each row gives the timestamp, the actor, the role they acted under, the action, the entity and its identifier, and a details column carrying the substance. The action is written as a plain-language phrase rather than a system identifier — *Message sent*, *Engagement created*, *Site settings updated* — so the column can be read by someone who has never seen the platform's internals. The rows at the head of the log are Grace Mutindi's message, recorded with its concierge scope and its visibility to the investor; five engagements she created within the same minute, each carrying its approved status, the investor's name and the project it was raised against, from the MNHSA Livingstone Flats Project through to the Kumusha Power Project; and, beneath them, a Platform Admin's change to the site settings, recorded with the banner display mode it was set to.

The details column is the part that carries assurance weight, because it preserves the substance of an act — which project, which investor, which setting — rather than only the fact that something happened. Ninety-three entries is a short ledger, and that is the correct thing for it to be: what is recorded here is institutional acts rather than system noise, which is the condition on which an auditor can read the whole of it instead of sampling it. Note also whose entries these are: alongside a qualified investor's engagements sits the Platform Admin's own change to the platform's configuration, logged on identical terms. The tier that can alter the rules is recorded in the same ledger as the tier that operates within them, and the export puts that ledger in an auditor's hands without needing the platform to interpret it first.
...
Every governance status is filterable from one row of chips, and the counts reconcile: thirty-seven in total, made up of one draft, three submitted, four in review, one with changes requested, one approved, twenty-six published and one archived, with investor proposals identified separately and none currently recorded. The table view shows title, sector, status, capital and last update — Goromonzi Agro Processing Industrial Park at US$36.9 million, TelOne Fibre to the Home at US$50 million, CICADA Macadamia and Avocado at US$39.5 million — and can be swapped for kanban, list or matrix.

This console and the ZIDA Admin's carry the registry whole — archived records, unsubmitted drafts and investor-originated proposals filterable in the same list as the published projects. That completeness is what allows the owner tier to answer a question about the national pipeline without asking anyone to compile it. The capital column is equally instructive: each requirement resolves to a single parsed headline figure, with the requirement as it was transcribed from the source deck held on the project's own page, and three of the ten rows on this first page show no figure at all because none has yet been recorded against them. The registry displays what has been submitted rather than a tidied estimate, which is what pending validation looks like in practice, and it is the honest position for a pilot.

![The platform-wide review queue.](docs/screenshots/superadmin/review.png)

Nine new submissions are stacked as cards, with a second tab for pending amendment and ministry association requests. Each card names the project and the ministry it is filed against — Mazowe Valley Irrigation Revitalisation under Lands, Agriculture, Fisheries, Water and Rural Resettlement, described as 4,200 hectares of gravity-fed irrigation; Powertel Fibre Internet (GPON) under Information Communication Technology, Postal and Courier Services — and offers expanders for full project detail and action history, a reviewer notes box, and a row of actions: request changes, approve, publish and reject, with send back to draft and start review greyed until applicable.

Look at that action row again, because it is the clearest picture of this tier in the whole console. Approve and publish sit side by side on one card. At every other tier they are held apart — the same card in the ZIDA Admin console offers request changes, approve and reject, but no publish — and the separation between clearing a project and placing it on the national registry is the core of the governance model. The page states the mechanism in its own subtitle: buttons render from the signed-in role's entitlements rather than from a fixed layout, so what an officer can see is exactly what they are authorised to do.
...
Ten records are grouped by stage: four with no memorandum yet, and one at each of drafting, in review, both parties approved, finalised, ready for signature and executed. The table pairs each investor and their organisation with the project, so Nomsa Dube of Kestrel Capital Partners appears against Masuwe International Medical Center and Grace Mutindi of Zambezi Growth Partners against Kumusha Power Project. Two columns run alongside each other — engagement status and memorandum stage — with ticket sizes where an investor has stated one, from US$25–100 million down to a dash.
...
The Government Executive Report is generated on demand and stamped: named to Amara Sesay as Platform Admin, timed to the second, referenced REP-20260907-01A4, sourced to live platform data and marked for government use. Its command strip carries four measures — total pipeline value of US$2.34 billion across thirty-seven projects, investor capital coverage of 2.8 per cent representing US$61 million committed against US$2.21 billion published, average review turnaround of 10.9 days across thirty-one submissions, and a funnel conversion rate of 66.7 per cent, being six approved of the nine engagements in flight. Below sit the counts — thirty-seven projects, twenty-six published, ten investor engagements, thirty-four registered users and seven leads received — and an economic impact block giving average project size of US$77.99 million across the thirty projects that carry a figure, and a publication rate of 70.3 per cent. A Pipeline by Status table then reconciles the portfolio stage by stage, from one draft through three submitted for review, four under review, one with changes requested and one approved to twenty-six published and one archived, and two charts close the document: capital required by sector, led by Manufacturing ahead of ICT and Infrastructure, and provincial pipeline distribution, led by Masvingo ahead of multi-province or national projects and Harare. Each chart carries a link to its underlying data table.

Provenance is what makes this printable and defensible. A briefing tabled at a ministry can be checked back against the platform by reference, timestamp and generating officer, so the figures in the room and the figures in the system are the same figures. Just as important is what the strip refuses to smooth: capital coverage of 2.8 per cent is displayed as prominently as the pipeline total, with the action it implies attached to it. A report that surfaces its own weak measure is the only kind worth reading the strong ones from.

### Communication Hub, Profile and Account

![Staff messaging.](docs/screenshots/superadmin/communication.png)

Three threads sit in a single inbox, sorted into general enquiries, active deals and engagements — one general and two attached to deals. The open thread is Grace Mutindi's general enquiry, described on the page as a project-less concierge thread and carrying a stated response expectation of one business day; its single message, *Sector guidance ahead of a Q4 allocation*, asks which published opportunities are closest to financial close and where a ministry sponsor is already engaged. The two threads beneath it, on the TelOne Data Centres Project and the Eunigaga Chegutu Solar PV Power Plant, each record an amendment request as their most recent entry, raised by a named officer. The composer carries a visibility selector currently set to visible to investor.

Correspondence and formal acts are not held in separate systems here, which is the difference that matters in a dispute. The amendment request, its routing, the decision it awaits and the conversation around it occupy one sequence, so the reasoning behind an outcome survives alongside the outcome itself. The visibility selector makes the audience of every message explicit rather than assumed, and the CSV and PDF exports let a thread be filed with a ministry's own records in a form that leaves the platform intact.

![My Profile.](docs/screenshots/superadmin/profile.png)

Amara Sesay's account is shown with its address and Platform Admin badge, above a note that this is the same view ZIDA staff see on the holder's institutional compliance dossier. The company and representative block gathers entity name, corporate phone, authorised representative, representative title, job title, corporate website, business registration identifier and head office address, described as the identity of record that prepopulates read-only fields when a project is proposed or an application filed. The fields are complete on this account — Afronovation, Inc., a head office in Cary, North Carolina, the registration identifier NC-2114887 and Amara Sesay as Platform Operations Manager — and the page reports the company details up to date, with a compliance and documents section following below.
